...
ActiveRecord::Schema[8.0].define(version: 2025_09_23_192339) do
  ...
  create_table "pratos_restaurantes", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "prato_id", null: false
    t.bigint "restaurante_id", null: false
    t.index ["prato_id"], name: "index_pratos_restaurantes_on_prato_id"
    t.index ["restaurante_id"], name: "index_pratos_restaurantes_on_restaurante_id"
  end
